...
public class all_hell : MonoBehaviour {
    ...
    void Start()
    {
        ...
        cameraPivot = Camera_1.GetComponent<Transform>();
        movepic();
        changetype();
    ...
    void changetype()
    {
        ...
        string path1 = "file://" + Application.streamingAssetsPath + "\\"+type + ".png";
    ...
    void FixedUpdate()
    {
        ...
        if (direction == 1)
        {
            if (cameraPivot.position.x <= weight)
            {
                cameraPivot.Translate(speed * Time.deltaTime, 0, 0);
                //Debug.Log(Camera_1.GetComponent<Transform>().position);
            }
            else
            {
                cameraPivot.position = new Vector3(-1 * weight, 0, Cam_po_y);
            }
        ...
        {
            if (cameraPivot.position.x >= -1 * weight)
            {
                cameraPivot.Translate(-speed * Time.deltaTime, 0, 0);
            ...
            {
                cameraPivot.position = new Vector3(weight, 0, Cam_po_y);
            }
